# Experimenting ML Model on an actual Trade
...
# Preparing model to predict Stock Price for next 10 trading days starting from 12 June 2020
start = "2020-05-01"
End = "2020-06-11"
df1 = wb.DataReader(Stock, data_source = 'yahoo', start = start, end=End)
data_source1 ="/Users/lianjiade/Desktop/Stock_Data/LSCC.1.csv"
df1.to_csv(data_source1)
df1 = pd.read_csv("/Users/lianjiade/Desktop/Stock_Data/LSCC.1.csv",parse_dates=True,squeeze=True)

data1 = df1[['Close']]
data1['rsi14'] = talib.RSI(df1['Close'],timeperiod=14)


# get last 10 rows of data to predict stock price for next 10 days
data_for_prediction= data1[-10:]

X1 = np.array(data_for_prediction )
